...
def control_motor():
    ...
    try:
        ...
        if action == "off":
            ...
            return jsonify(
                {"status": "success", "message": "Motor turned OFF"}
            ), 200
            ...
            return jsonify(
                {"status": "success", "message": f"Speed set to {speed_value}%"}
            ), 200
...
def get_motor_status():
    ...
    try:
        ...
        return jsonify(
            {"status": "success", "motor_speed": 0, "motor_status": "off"}
        ), 200
    except Exception as e:
        return jsonify({"status": "error", "message": str(e)}), 500
...
def control_feeder():
    ...
    try:
        ...
        if action == "off":
            ...
            return jsonify(
                {"status": "success", "message": "Feeder turned OFF"}
            ), 200
...
def get_feeding_status():
    ...
    try:
        ...
        return jsonify(
            {"status": "success", "feeder_speed": 0, "feeder_status": "off"}
        ), 200
    except Exception as e:
        return jsonify({"status": "error", "message": str(e)}), 500
...
def add_reading():
    ...
    try:
        ...
        return jsonify(
            {"status": "success", "message": f"Reading saved for {device_id}"}
        ), 200
    except Exception as e:
        return jsonify({"status": "error", "message": str(e)}), 500
...
def api_check_feed_command():
    ...
    return jsonify(
        {"status": "success", "device_id": device_id, "command": "none"}
    ), 200
